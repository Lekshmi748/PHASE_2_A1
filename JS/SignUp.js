...
pwd.addEventListener('keyup', function() {
  ...
  if(strength==1){
    ...
    document.getElementById("medium").style.backgroundColor = "lightgrey";
    document.getElementById("strong").style.backgroundColor = "lightgrey";
    document.getElementById("strength").innerHTML = "password is very poor";
...
function validatePassword(){
  if(!(pwdRegexp.test(pwd.value))){
    ...
    pwd.setAttribute('placeholder','min 8 chars,1 uppercase,1 lower case,1 num required');
...
function validateNumber(){
  if(!mobileRegexp.test(mobile.value)){   
    ...
    mobile.style.border=("4px solid red");
    return false;
  }
  else{
...
function validatePasswordConfirm(){
  if(pwd.value!=pwdconfirm.value){
    ...
    pwdconfirm.style.border=("4px solid red");
    return false;
  }
  else{
